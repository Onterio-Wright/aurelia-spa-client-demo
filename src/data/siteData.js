...
export const homeStats = [
  { value: 'Funding Strategy', label: 'SBIR/STTR, ARPA-H, translational research, and milestone-aligned opportunity mapping.' },
  { value: 'Accounting & Compliance', label: 'Grant operations, reporting discipline, and audit-ready process design.' },
  { value: 'Commercial Positioning', label: 'Executive-ready messaging for reviewers, partners, and investors.' },
];

export const clientTypes = [
  { title: 'Innovative companies', description: 'Biotech, medtech, diagnostics, advanced materials, climate, and other research-intensive ventures.', icon: FlaskConical },
  { title: 'Universities & institutes', description: 'Academic teams, translational research centers, and commercialization programs moving science toward real-world adoption.', icon: Landmark },
  { title: 'Accelerators & ecosystems', description: 'Innovation programs seeking scalable advisory support for multiple founders, investigators, or portfolio companies.', icon: Building2 },
];
...
export const aboutSections = [
  {
    title: 'What we do',
    copy:
      'Aurelia Scientific Advisory supports organizations advancing science and technology. We help founders, investigators, and program leaders secure funding, manage grant-backed growth, and present their work with clarity to reviewers, partners, and stakeholders.',
  },
  {
    title: 'How we work',
    copy:
      'Our engagements are built around strategic clarity, disciplined execution, and a premium client experience. That means strong communication, organized workstreams, and deliverables that feel ready for institutional review.',
  },
  {
    title: 'Why it matters',
    copy:
      'Scientific teams often sit at the intersection of technical complexity, funding pressure, and operational growth. We help reduce friction across those areas so leadership can move faster with more confidence.',
  },
];
...
export const servicesPageSections = [
  {
    ...
    text:
      'From early opportunity evaluation through final package review, we help teams pursue the right funding pathways and improve the strength of every submission.',
    checklist: ['Agency and program fit', 'Roadmap and calendar planning', 'Proposal narrative development', 'Final technical and editorial review'],
    icon: FileText,
  },
  {
    heading: 'Grant accounting and compliance operations',
    text:
      'Winning funding is only the beginning. We help build the financial controls, reporting workflows, and internal discipline required to manage awards responsibly.',
    checklist: ['Budget controls and expense handling', 'Reporting cadence design', 'Documentation readiness', 'Leadership visibility and oversight'],
    icon: ShieldCheck,
  },
  {
    heading: 'Commercialization and strategic finance',
    text:
      'For teams moving from technical success toward market traction, we support milestone packaging, stakeholder messaging, and practical strategic planning.',
    checklist: ['Commercial roadmap support', 'Investor and partner materials', 'Strategic finance alignment', 'Cross-functional planning support'],
    icon: LineChart,
  },
];
...
export const caseStudies = [
  {
    ...
    result: 'The engagement produced a clearer opportunity sequence, more persuasive technical communication, and a stronger executive narrative.',
  },
  {
    ...
    result: 'We structured cleaner workflows, stronger documentation habits, and more consistent oversight across grant-backed operations.',
  },
  {
    ...
    result: 'We provided a more consistent intake process, stronger prioritization, and clearer support pathways across participating teams.',
  },
];
...
export const faqItems = [
  {
    ...
    answer: 'The site is positioned for innovative companies, university and translational teams, incubators, accelerators, and other research-driven organizations.',
  },
  {
    question: 'Can this be customized for a real firm?',
    answer: 'Yes. Brand colors, team bios, case studies, contact information, booking links, and service language are easy to swap into the current structure.',
  },
  {
    question: 'Is this polished enough to demo to a potential client?',
    answer: 'Yes. The site uses client-facing language, a professional visual system, and service framing that matches the scientific advisory category.',
  },
];

export const footerNote = 'Aurelia Scientific Advisory helps scientific innovators secure funding, strengthen operations, and grow with confidence.';

export const homeImages = {
  hero: 'https://images.unsplash.com/photo-1581092919535-7146ff1a5903?auto=format&fit=crop&w=1400&q=80',
  about: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1400&q=80',
  services: 'https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?auto=format&fit=crop&w=1400&q=80',
};
